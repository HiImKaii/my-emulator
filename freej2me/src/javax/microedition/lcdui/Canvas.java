...
public abstract class Canvas extends Displayable
{
	...
	public void repaint()
	{
		...
		{
			System.out.print("Canvas paint(): "+e.getClass().getName()+": "+e.getMessage());
			e.printStackTrace();
		}
		// Always flush to screen, even if paint() threw an exception
	...
	public void repaint(int x, int y, int width, int height)
	{
		...
		{
			System.out.print("Canvas paint(xywh): "+e.getClass().getName()+": "+e.getMessage());
			e.printStackTrace();
		}
		// Always flush to screen, even if paint() threw an exception
		if(Mobile.getDisplay().getCurrent() == this)
